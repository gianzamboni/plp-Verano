...
Podemos usarla crear una función \haskell{sumarUno :: Int -> Int} instanciando su primer parámetro en 1:
...
\paragraph{Maybe} El tipo \haskell{Maybe}, definido en el último ejemplo, nos permite expresar la posibilidad de que el resultado sea erróneo, sin necesidad de usar casos especiales. De esta forma, logramos evitar el uso de $\bot$ (indefinido) hasta que el programador lo decida, permitiendo controlar errores.
