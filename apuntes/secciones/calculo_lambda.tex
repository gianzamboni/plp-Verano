...
Para conseguir las variables libres de una expresión, definimos $FV$ como una fución que toma como parámetro una expresión y devuelve el conjunto de variables libres de la misma.
