...
\paragraph{c)}
	...
	\begin{center}\small
        ...
        \AxiomC{$\OOReduccion{[~x=0,~y = 0,~ \OOAtributo{mv}{p}{\lambda(x_1)\lambda(x_2) z.mv(p,x_1,x_2)}]\{z\leftarrow Punto\}}{p}$}
    \RightLabel{[Sel]}
