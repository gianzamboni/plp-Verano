\left( \documentclass[10pt,a4paper]{article}
\input{header}
...
\subsubsection{}
    ...
    // Ó
    PuntoColoreado.prototype.cons = function (x,y,color) {
        this.x=x;
        this.y=y;
        this.color = "rojo";
    }
...
\subsubsection{}
        ...
        var pc1 = new PuntoColoreado(1 ,2);
        Punto.prototype.mover = "me muevo";
        var p2 = new Punto(1 ,2);
        var pc2 = new PuntoColoreado(1 ,2);
