...
Y, además, definimos $new$ como un constructor que crea un objeto con las mismas etiquetas que el trait y que asocia a cada una de ellas un método que invoca al método del trait correspondiente con su primer parámetro ligado a \texttt{self}:
