...
El lenguaje lambda que usamos en la materia tiene dos tipos $Bool$ y $\sigma\rightarrow\theta$ que representan son los tipos de los valores booelanos y las funciones que van de un tipo $\sigma$ a un tipo $\theta$, respectivamente. Y lo notamos:
\begin*{align}
	\sigma,\theta ::= Bool | \sigma\rightarrow\theta
\end{align}

Esta definición nos permite dar tipo a las expresiones y las definiciones y junto con el sistema de tipado acotan nuestro conjunto de expresiones validas.
\subsection{}
\appendix
